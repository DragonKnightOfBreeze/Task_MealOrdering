package dk_breeze.test.json;

import dk_breeze.utils.JSONUtils;

public class Test1 {
	public static void main(String[] args) {
//		JSONReader json = new JSONReader(new FileReader("D:\\My Documents\\My Projects\\Java Projects\\Task\\Task_MealOrdering\\MyTest\\src\\dk_breeze\\test\\json\\test1.json"));
//		System.out.println(json);
//		System.out.println(json.readString());
//		JSONArray array = new JSONReader(new FileReader("D:\\My Documents\\My Projects\\Java Projects\\Task\\Task_MealOrdering\\MyTest\\src\\dk_breeze\\test\\json\\test1.json");
//		array
