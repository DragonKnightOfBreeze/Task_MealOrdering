			...
			<div class="col-sm-9">
				<div class="container" id="mo_body-page-admin">
					...
					<div class="row m-3" id="mo_body-content-admin">
						<!--STEP 显示和编辑公告信息的表单-->
						<form class="m-auto" id="mo_form-info" action="<c:url value="/mealordering/admin/edit-notice"/>"
						      method="post">
							<!--显示公告id-->
							<div class="form-row m-1">
								<label class="col-sm-3" for="mo_id">id</label>
								<div class="col-sm-9 input-group">
									<input type="text" class="form-control disabled" id="mo_id" value="${notice.id}" disabled>
							...
							<div class="form-row m-1">
								...
								<div class="col-sm-9 input-group">
									<input type="text" class="form-control" id="mo_title" name="title" value="${notice.title}" required>
								</div>
							</div>
							<!--显示和输入公告详情-->
							<div class="form-row m-1">
								<label for="mo_details">详情</label>
								<textarea class="form-control" id="mo_details" rows="4" name="details">${notice.details}</textarea>
							</div>
							<!--删除、返回以及确认更改按钮-->
							<div class="form-row m-1">
								<div class="col-sm-4">
