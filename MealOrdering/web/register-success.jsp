...
<body>
	...
	<!--STEP 页面主体-->
	<div class="container" id="mo_body-success">
		<div class="row  m-3" id="mo_body-title-success">
			<h2 class="m-auto text-success">注册成功！</h2>
		</div>
		<hr>
		<div class="row m-3" id="mo_body-content-success">
	...
	<!--引入自定义脚本-->
	<script src="<c:url value="/mealordering/assets/js/utils/countDown.js"/>"></script>
</body>
</html>
